%% Learn a hybrid automata model with neuralODEs for each location
...
hS = 20; % number of neurons in each hidden layer
...
learnHybridAutomata(data, odeType, Ts, time, sigma, winlen, eta, lambda, gamma, act_function, nL, hS);
