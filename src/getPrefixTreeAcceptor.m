function pta_trace = getPrefixTreeAcceptor(trace)
% This function generates a prefix tree acceptor (PTA) for each trace
num = 1;
seg_ids = [];
for n = 1:length(trace)
    ...
    for i = 1:length(labels_trace)-1
        ...
        pta_trace_temp.id1 = num; %s ource state id
...
function pta_trace_new = combine_pta(pta_trace1, pta_trace2)
...
% Get pta trace from a given segment index n
