...
neuralOdeParameters{2*numLayers+3} = initializeGlorot(sz, stateSize, hiddenSize);
neuralOdeParameters{2*numLayers+4} = initializeZeros([stateSize 1]);
